...
function fnGetQuestions() {
    ...
    var jdata = {
        uid: $('#hdfUserId').val(), examid: $('#hdfExamId').val(), langid: $('#dynamic_select').val(), type: 'getrequestions'
    }
...
function updateQuestiontime(queid) {
    var jdata = {
        uid: $("#hdfUserId").val(), qnsid: queid, examid: $("#hdfExamId").val(), type: 'updatereqnstime'
    }
    url_add = window.location.href;
    var data = url_add.split("://")
    var protocol = data[0];
...
function fnOptionEndExam(sId, fId, QnsId, OptId) {
   ...
   document.getElementById('divmainloading').style.display = 'block';
    ...
    var jdata = {
        rzs: totalAttempt, gzs: correctAns, uid: $("#hdfUserId").val(), qnsid: QnsId, optid: OptId, rightans: rightans, type: 'optresubmitans'
    }
    url_add = window.location.href;
    var data = url_add.split("://")
    var protocol = data[0];
...
function fnEndExam(sId, fId) {
    if (confirm("Are you sure you want to end the exam?") == true) {
        ...
        var jdata = {
            rzs: totalAttempt, gzs: correctAns, uid: $('#hdfUserId').val(), type: 'submitreans'
        }
        url_add = window.location.href;
        var data = url_add.split("://")
        var protocol = data[0];
